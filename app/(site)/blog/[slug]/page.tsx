            ...
            <MDXRemote
              ...
              options={{
                mdxOptions: {
                  ...
                  rehypePlugins: [rehypeUnwrapBoldParagraphs, rehypeKatex, rehypeCollapsibleCode, [rehypePrettyCode, { theme: 'material-theme-palenight', keepBackground: false }], rehypePostA11y],
                },
              }}
            />
          </div>
