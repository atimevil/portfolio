...
const UI = {
  ...
  built: { ko: '만든 것', en: 'Built' },
  measured: { ko: '잰 것', en: 'Measured' },
  builtLede: { ko: '돌아가는 시스템. 구조도를 누르면 상세로 갑니다.', en: 'Working systems. Open one for the full write-up.' },
  measuredLede: { ko: '모델이 어디서 틀리는지 숫자로 확인한 기록입니다.', en: 'Where models fail, checked in numbers.' },
  record: { ko: '이력', en: 'Record' },
