...
const UI = {
  ...
  projectsLede: { ko: '논문으로 낸 연구와 직접 만들어 쓴 도구들입니다.', en: 'Research I have published and tools I have built.' },
  awardsLede: { ko: '대회와 교육 과정에서 남긴 기록입니다.', en: 'Competitions and programs I have taken part in.' },
  postsLede: { ko: '연구 기록과 프로젝트 회고를 씁니다.', en: 'Research notes and project retrospectives, written in Korean.' },
  seeMore: { ko: '더 보기', en: 'See more' },
